...
public class ReviewableControllerIntegrationTest {
    ...
    void updateReviewers_createsActivityForAddAndRemove() throws Exception {
        ...
        Supervisor supervisor2 = supervisorRepository.save(
        ...
        List<String> descriptions = lastActivities.stream().map(ActivityDTO::getDescription)
