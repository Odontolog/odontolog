...
class JwtUtilTest {
  ...
  void verifyFailsWithWrongSecret() {
    ...
    assertThatThrownBy(() -> utilB.verify(token)).isInstanceOf(JWTVerificationException.class);
  }
  ...
  void expiredTokenShouldFail() {
    ...
    assertThatThrownBy(() -> jwtUtil.verify(token)).isInstanceOf(TokenExpiredException.class);
  }
  ...
  void tamperedTokenShouldFail() {
    ...
    assertThatThrownBy(() -> jwtUtil.verify(tampered)).isInstanceOf(JWTVerificationException.class);
  }
