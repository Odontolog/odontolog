...
public class ReviewableSpecification {
    ...
    public static Specification<Reviewable> isAwaitingReviewBy(Supervisor supervisor) {
        return (root, query, criteriaBuilder) -> {
            ...
            Predicate supervisorPredicate = criteriaBuilder.equal(reviewJoin.get("supervisor"), supervisor);
            Predicate statusPredicate = criteriaBuilder.equal(reviewJoin.get("reviewStatus"), ReviewStatus.PENDING);
