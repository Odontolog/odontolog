...
public class DevDataLoader implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        try {
            ...
            Student studentTest002 = studentRepository.save(
                    Student.builder()
            ...
            Student studentTest003 = studentRepository.save(
                    Student.builder()
            ...
            Supervisor supervisorTest002 = supervisorRepository.save(
                    Supervisor.builder()
            ...
            Supervisor supervisorTest003 = supervisorRepository.save(
                    Supervisor.builder()
            ...
            Supervisor supervisorTest004 = supervisorRepository.save(
                    Supervisor.builder()
            ...
            Patient patientTest002 = patientRepository.save(
                    Patient.builder()
                            .name("Mário Telles")
                            .birthDate(LocalDate.parse("1990-01-01"))
                            .CPF("123.456.780-00")
            ...
            Patient patientTest003 = patientRepository.save(
                    Patient.builder()
            ...
            Patient patientTest004 = patientRepository.save(
                    Patient.builder()
            ...
            Patient patientTest005 = patientRepository.save(
                    Patient.builder()
            ...
            Review reviewTest003 = Review.builder().reviewStatus(ReviewStatus.DRAFT).supervisor(supervisorTest001)
                    .build();
            ...
            Review reviewTest002 = Review.builder().reviewStatus(ReviewStatus.DRAFT).supervisor(supervisorTest001)
                    .build();
