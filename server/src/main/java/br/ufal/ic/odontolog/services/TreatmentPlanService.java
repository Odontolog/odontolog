...
public class TreatmentPlanService {
    ...
    @Transactional
    public TreatmentPlanDTO assignUserToTreatmentPlan(TreatmentPlanAssignUserRequestDTO requestDTO,
            Long treatmentId) {
        TreatmentPlan treatmentPlan = treatmentPlanRepository.findById(treatmentId)
