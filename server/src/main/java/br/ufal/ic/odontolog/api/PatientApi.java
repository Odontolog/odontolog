...
public interface PatientApi {
  ...
  @Operation(
      ...
      description = "Retrieves a list of all patients that are not soft-deleted.")
  @ApiResponses(
      value = {@ApiResponse(responseCode = "200", description = "Patients retrieved successfully")})
  ResponseEntity<List<PatientDTO>> getAllPatients();

  @Operation(
      summary = "Search patients by term",
      description = "Search patients by name or other criteria, limited to the first 10 results.")
  @ApiResponses(
  ...
  ResponseEntity<List<PatientAndTreatmentPlanDTO>> searchPatient(
      @Parameter(description = "Optional search term") @RequestParam(name = "term")
  ...
  @Operation(
      summary = "Get next appointment of a patient",
      description = "Retrieve the next scheduled appointment of a patient.")
  @ApiResponses(
      value = {
  ...
  @Operation(
      summary = "Update next appointment of a patient",
      description = "Update the next scheduled appointment of a patient.")
  @ApiResponses(
      value = {
  ...
  ResponseEntity<Void> deletePatient(
      @Parameter(description = "ID of the patient") @PathVariable Long id,
      @Parameter(description = "Soft delete flag, default is true")
          @RequestParam(defaultValue = "true")
          boolean soft);

  @Operation(
      summary = "Restore a soft-deleted patient",
      description = "Restore a patient that was soft-deleted.")
  @ApiResponses(
      value = {
