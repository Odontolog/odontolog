...
import { HasNotes, Mode } from '@/shared/models';

export interface NotesSectionProps<T extends HasNotes> {
  id: string;
...
export default function NotesSection<T extends HasNotes>({
  id,
  queryOptions,
  mode = 'edit',
  mutateFn,
...
interface DetailSectionContentProps<T extends HasNotes>
...
function DetailSectionContent<T extends HasNotes>({
  id,
  notes,
  isLoading,
  isError,
